...
echo -e "${REDBG}${YLW}                      OWASP ATTACKFORGE INSTALLER                       ${RST}"
echo -e "${REDBG}${YLW}                                                                        ${RST}"
_print_ascii_art
...
DEFAULT_DOMAIN="hackthacker.lab"
DEFAULT_ORG="OWASP AttackForge"
DEFAULT_DBUSER="hackthacker"
DEFAULT_DBPASS="hackthacker"
